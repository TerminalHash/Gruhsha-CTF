...
void DrawResupplyOnHUD(CBlob@ this, Vec2f tl)
{
	...
	if (next_items > getGameTime())
	{
		...
		if (hover)
		{
			GUI::DrawText(resupply_unavailable, icon_pos + Vec2f(icon_size.x * 2 - dim_res_unav.x + 8, text_height_pos), color_white);
		}
	}
	else
	{
		...
		if (hover)
		{
			GUI::DrawText(resupply_available, icon_pos + Vec2f(icon_size.x * 2 - dim_res_av.x + 8, text_height_pos), color_white);
		}
	}
}

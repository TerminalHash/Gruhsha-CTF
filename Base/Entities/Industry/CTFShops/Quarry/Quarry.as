...
void GetButtonsFor(CBlob@ this, CBlob@ caller) {
	...
	// dont show button, if wood pool is empty
	// TODO: try to use button.SetEnabled thing instead this,
	// im wanna save ability to put real wood into quarry in future
	if (getRules().get_s32("teamwood" + caller.getTeamNum()) < 150) return;
...
void onCommand(CBlob@ this, u8 cmd, CBitStream @params)
{
	if (cmd == this.getCommandID("add fuel") && isServer())
	{
		...
		//how much fuel does the caller have including what's potentially in his hand?
		int callerQuantity = getRules().get_s32("teamwood" + caller.getTeamNum());

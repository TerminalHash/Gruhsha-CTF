...
void onInit(CBlob@ this)
{
	...
	//TDM classes
	addPlayerClass(this, "Builder", "$builder_class_icon$", "builder", "Drill your enemies.");
...
void GetButtonsFor(CBlob@ this, CBlob@ caller)
{
	...
	AddIconToken("$flail_class_icon$", "GUI/MenuItems_MOD.png", Vec2f(32, 32), 33, caller.getTeamNum());
	AddIconToken("$rogue_class_icon$", "GUI/MenuItems_MOD.png", Vec2f(32, 32), 34, caller.getTeamNum());

...
void SetDefaultBackgrounds(CRules@ rules)
{
    ...
    // we using our background, so vanilla sprites is disabled
    ...
    RepeatedParallaxBackground@ sprucetrees = AddScriptedBackground("Sprites/Back/BackgroundSpruceTrees.png", Vec2f(0.0f,  -182.0f), 0.18f, 30.0f, color_white, baseZ + 10.0f);
    sprucetrees.stretchDown = true;
    ...
    for (int i = 0; i < cloudBehindPlains; ++i)
    {
        ...
        AddCloud(@sprucetrees, -5.0f + (i * 0.1f), Vec2f(0.0f, 145.0f), Vec2f(1024.0f, 100.0f), parallaxAmplitude, SColor(60, 242, 247, 250));
    }
    ...
    for (int i = 0; i < cloudInFrontPlains; ++i)
    {
        ...
        AddCloud(@sprucetrees, 5.0f + (i * 0.1f), Vec2f(0.0f, 150.0f), Vec2f(1024.0f, 30.0f), parallaxAmplitude, SColor(20, 230, 235, 238));
    }

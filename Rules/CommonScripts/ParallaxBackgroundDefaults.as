...
void SetDefaultBackgrounds(CRules@ rules)
{
    ...
    for (int i = 0; i < cloudBehindPlains; ++i)
    {
        ...
        AddCloud(@sprucetrees, -5.0f + (i * 0.1f), Vec2f(0.0f, 145.0f), Vec2f(1024.0f, 70.0f), parallaxAmplitude, SColor(60, 242, 247, 250));
    }
    ...
    for (int i = 0; i < cloudInFrontPlains; ++i)
    {
        ...
        AddCloud(@sprucetrees, 5.0f + (i * 0.1f), Vec2f(0.0f, 150.0f), Vec2f(1024.0f, 30.0f), parallaxAmplitude, SColor(30, 230, 235, 238));
    }
